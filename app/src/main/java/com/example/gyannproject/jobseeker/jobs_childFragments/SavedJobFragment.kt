...
class SavedJobFragment : Fragment() {
    ...
    companion object {
        @JvmStatic
        fun saveJobInstance() =  SavedJobFragment()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newJobRecyclerView = view.findViewById(R.id.recyclerViewchildJobssaved)
    ...
    private fun getJobsData() {
        ...
        newjobList.add(NewJobsDataClass(R.drawable.new_job, "Sr. UX Designer", "Amazon", "Remote(Anywhere)", "12/03/24", R.drawable.saved_job))
        newjobList.add(NewJobsDataClass(R.drawable.new_job, "Sr. UX Designer", "Amazon", "Remote(Anywhere)", "12/03/24", R.drawable.saved_job))
        newjobList.add(NewJobsDataClass(R.drawable.new_job, "Sr. UX Designer", "Amazon", "Remote(Anywhere)", "12/03/24", R.drawable.saved_job))
        newjobList.add(NewJobsDataClass(R.drawable.new_job, "Sr. UX Designer", "Amazon", "Remote(Anywhere)", "12/03/24", R.drawable.saved_job))
        newjobList.add(NewJobsDataClass(R.drawable.new_job, "Sr. UX Designer", "Amazon", "Remote(Anywhere)", "12/03/24", R.drawable.saved_job))
